...
public final class BlockRegistryImpl {
	...
	public static final DefaultedRegistry<ExtBlock> REGISTRY = Registries.registerDefaulted(RegistryKeys.BLOCK, NamespacedIdentifiers.from("air"), () -> ExtBlock.BY_ID.getClass());
	...
	public static NamespacedIdentifier getIdentifier(ExtBlock block) {
		return REGISTRY.getIdentifier(block);
	}

	public static ResourceKey<ExtBlock> getKey(ExtBlock block) {
	...
	public static ExtBlock getBlock(NamespacedIdentifier identifier) {
		return REGISTRY.get(identifier);
	}

	public static ExtBlock getBlock(ResourceKey<ExtBlock> key) {
